...
class _AppBarHomeState extends State<AppBarHome> {
  ...
  void initState() {
    super.initState();
    appBarTheme = widget.viewmodel.isDark
        ? UiConfigTheme.themedark.appBarTheme.backgroundColor!
        : UiConfigTheme.themelight.appBarTheme.backgroundColor!;
  }
  @override
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: () async => await widget.viewmodel.mudarMes(-1),
                  ...
                  child: Row(
                    ...
                    children: [
                      widget.viewmodel.canSeeValue
                          ? _saldo(
                              widget.viewmodel
                                  .formatarMoeda(widget.viewmodel.saldo)
                                  .trim(),
                              'Saldo atual')
                          : _saldo('***', 'Saldo atual'),
                      widget.viewmodel.canSeeValue
                          ? _saldo('134,87', 'Limite disponível')
                          : _saldo('***', 'Limite disponível'),
                    ],
                  ),
                );
              }),
