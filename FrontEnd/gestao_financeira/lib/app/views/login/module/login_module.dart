...
import 'package:gestao_financeira/app/views/cadastro/module/cadastro_module.dart';
...
class LoginModule extends Module {
  ...
  List<ModularRoute> get routes => [
    ...
    ModuleRoute("${LoginNomeRotas.login}${CadastroNomeRotas.modulo}",  module: CadastroModule()),
  ];
}